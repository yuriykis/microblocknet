...
type TxInput struct {
	...
	PublicKey  string `protobuf:"bytes,3,opt,name=public_key,json=publicKey,proto3" json:"public_key,omitempty"`
	Signature  string `protobuf:"bytes,4,opt,name=signature,proto3" json:"signature,omitempty"`
	PrevTxHash string `protobuf:"bytes,5,opt,name=prev_tx_hash,json=prevTxHash,proto3" json:"prev_tx_hash,omitempty"`
}
...
func (x *TxInput) GetPrevTxHash() string {
	if x != nil {
		return x.PrevTxHash
	}
	return ""
...
var file_proto_types_proto_rawDesc = []byte{
	...
	0x65, 0x76, 0x5f, 0x74, 0x78, 0x5f, 0x68, 0x61, 0x73, 0x68, 0x18, 0x05, 0x20, 0x01, 0x28, 0x09,
